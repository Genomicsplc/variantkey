...
hashTestData = [
    ...
    (0x517e346c, 0xc2f8db8624fefc0e,
     "The major problem is with sendmail.  -Mark Horton"),
    (0x8a4b0b6c, 0x5a0a6efd52e84e2a,
     "How can you write a big system without C++?  -Paul Glick"),
    (0xb360937b, 0x786d7e1987023ca9,
     "He who has a shady past knows that nice guys finish last."),
    (0x2e5713b3, 0x5d14f96c18fe3d5e,
     "Free! Free!/A trip/to Mars/for 900/empty jars/Burma Shave"),
    (0xec6d1e0e, 0xec8848fd3b266c10,
     "His money is twice tainted: 'taint yours and 'taint mine."),
    (0x7175f31d, 0x2a578b80bb82147c,
     "The days of the digital watch are numbered.  -Tom Stoppard"),
    (0xdf4c5297, 0x55182f8859eca4ce,
     "For every action there is an equal and opposite government program."),
    (0x62359aca, 0xabcdb319fcf2826c,
     "You remind me of a TV show, but that's all right: I watch it anyway."),
    (0x398c0b7c, 0x1d85702503ac7eb4,
     "It's well we cannot hear the screams/That we create in others' dreams."),
    (0x47f9c, 0xa2b8bf3032021993,
     "Give me a rock, paper and scissors and I will move the world.  CCFestoon"),
    (0xe56239a7, 0x38aa3175b37f305c,
     "It's a tiny change to the code and not completely disgusting. - Bob Manchek"),
    (0xb556f325, 0x7e85d7b050ed2967,
     "There is no reason for any individual to have a computer in their home. -Ken Olsen, 1977"),
    (0x75cc5362, 0x5a05644eb66e435e,
     "Even if I could be Shakespeare, I think I should still choose to be Faraday. - A. Huxley"),
    (0xc401a0bf, 0x98eff6958c5e91a,
